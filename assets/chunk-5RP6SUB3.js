import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-HAONQIVH.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-JAAWZFEO.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-VZM6K2ZE-VG5CIJ73.js"), "loader")
    },
    {
      name: "swimlane",
      loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-SLNWSIFB-PSEVXQIB.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-JH36ORCC-2URKWBR4.js"), "loader")
      }
    ] : []
  ]);
